...
.contact form textarea {
  ...
  border-radius: 20px;
  color: #fff;
  margin: 0 0 12px 0; /* Increased margin for better spacing */
  padding: 16px 26px; /* Adjusted padding for better readability */
  font-weight: 500;
  font-size: 18px;
...
.contact form textarea:focus {
  ...
  color: #121212;
  border: 1px solid #121212; /* Improved contrast */
}
